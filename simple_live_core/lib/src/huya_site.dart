...
class HuyaSite implements LiveSite {
  ...
  Future<String> getHuYaUA() async {
    ...
    return playUserAgent ?? hySdkUserAgent;
  }
  ...
  Future<LivePlayUrl> getPlayUrls({
    ...
    return LivePlayUrl(urls: ls, headers: {"user-agent": hySdkUserAgent});
  }
